from utils import update_model, save_simplemetrics_report, get_model_performance_test_set
...
save_simplemetrics_report(train_score, test_score, validation_score, grid_search.best_estimator_)
